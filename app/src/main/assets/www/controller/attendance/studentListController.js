colorAdminApp.controller('studentListController', function ($scope, $rootScope, $http, $state, DTOptionsBuilder, DTColumnBuilder, $filter, $compile) {
        ...
        $scope.orderColumns = [
            ...
            DTColumnBuilder.newColumn(null).withTitle('Actions').notSortable()
                .renderWith(function (data, type, full, meta) {
                    return '<button class="btn btn-primary" ng-click="viewDetail(' + data.studentId + ')">' + ' <i class="fa fa-eye"></i>' + "View" + '</button>';
                })
        ];
    ...
    $scope.viewDetail = function (id) {
        $state.go('app.attendance.viewStudentDetail', { studentId: id });
    }
